...
public class PortalState {
    ...
    public static PortalState fromTag(CompoundTag tag) {
        ResourceKey<Level> fromWorld = Helper.dimIdToKey(tag.getStringOr("fromWorld", "minecraft:overworld"));
        ResourceKey<Level> toWorld = Helper.dimIdToKey(tag.getStringOr("toWorld", "minecraft:overworld"));
